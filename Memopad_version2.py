...
def Rate_Pad():  # lets user to rate the pad
    ...
    label = messagebox.showwarning("Memopad rating","I never store your information until you login with your email account. Sign out before submitting")
...
def updates():  # Describes the Updates in it
    label=messagebox.showinfo("Memopad Updates","*Update tab introduced \n* Updates introduced is shown here.")



def future():  # Future updates that will come
    label=messagebox.showinfo("Memopad Future Updates","*Word dictionary for searching words in memopad.\n Once this has been finished, it will show in update tab")
...
updatemenu.add_command(label='Future Update',command=future)
